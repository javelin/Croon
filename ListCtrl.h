...
protected:
    ...
    int ItemWidth() const { return Zx(sizeHint.cx == 0 ? _Zx(DefaultDim):sizeHint.cx) + margin*2; }
    int ItemHeight() const { return Zy(sizeHint.cy == 0 ? _Zy(DefaultDim):sizeHint.cy) + margin*2; }

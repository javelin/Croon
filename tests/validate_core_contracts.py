...
def main() -> None:
    ...
    require(lrc_preview_generator_cpp, "\"*@(255.0.0)\"", "LrcPreviewGenerator V1 red preview")
    require(lrc_preview_generator_cpp, "\"*@(0.0.255)\"", "LrcPreviewGenerator V2 blue preview")
    require(lrc_preview_generator_cpp, "\"*@(255.0.255)\"", "LrcPreviewGenerator both-singer purple preview")
    ...
    require(project_cpp, "void Project::ExportVideo(int length)", "Project video export implementation")

...
def main() -> None:
    ...
    require(subtitle_generator_cpp, "rowHeights.Add(lineHeight * (wrapped ? 2:1))", "SubtitleGenerator compact wrap-aware row stack")
    require(subtitle_generator_cpp, "currentY = resY - SubtitleBottomMargin - totalHeight", "SubtitleGenerator compact stack bottom anchor")
